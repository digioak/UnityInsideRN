...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformLookAtPosition : FsmStateAction
    {
        ...
        public override void Reset()
        {
            base.Reset();
            gameObject = null;
            towards = new FsmVector3 { UseVariable = false };
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLookAt(towards.Value, duration.Value, axisConstraint, up.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Transform Look At Position");

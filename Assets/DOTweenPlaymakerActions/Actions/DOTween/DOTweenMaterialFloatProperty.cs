...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Changes the target's named float property to the given one.")]
    ...
    public class DOTweenMaterialFloatProperty : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOFloat(to.Value, property.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Material Float Property");

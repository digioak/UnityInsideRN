...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Shakes the target's anchoredPosition with the given values. ")]
    ...
    public class DOTweenRectTransformShakeAnchorPos : FsmStateAction
    {
        ...
        public override void Reset()
        {
            base.Reset();
            gameObject = null;
            strength = new FsmVector2 { UseVariable = false };
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOShakeAnchorPos(duration.Value, strength.Value, vibrato.Value, randomness.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween RectTransform Shake Anchor Pos");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Changes the light's shadowStrength to the given one")]
    ...
    public class DOTweenLightShadowStrength : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Light>().DOShadowStrength(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Light Shadow Strength");

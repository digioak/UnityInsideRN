...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens the target's pivot to the given value, tweening only the Y axis.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenRectTransformPivotY : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOPivotY(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween RectTransform PivotY");

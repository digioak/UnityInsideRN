...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Changes the target's named color property to the given one.")]
    ...
    public class DOTweenMaterialColorProperty : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOColor(to.Value, property.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Material Color Property");

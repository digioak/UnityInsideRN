...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a Camera's nearClipPlane.")]
    ...
    public class DOTweenCameraNearClipPlane : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DONearClipPlane(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Camera NearClipPlane");

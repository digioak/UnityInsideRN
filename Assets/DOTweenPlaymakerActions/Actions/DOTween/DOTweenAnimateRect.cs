...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Animates a rect variable to a target value")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenAnimateRect : FsmStateAction
    {
        [RequiredField]
        ...
        [Tooltip("The variable you want to animate")]
        public FsmRect variable;

        [RequiredField]
        [UIHint(UIHint.FsmRect)]
        [Tooltip("The end value you want to animate to")]
        public FsmRect to;
        ...
        public override void Reset()
        {
            base.Reset();
            gameObject = null;
            variable = new FsmRect { UseVariable = true };
            to = new FsmRect { UseVariable = false };
        ...
        public override void OnEnter()
        {
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Animate Rect");

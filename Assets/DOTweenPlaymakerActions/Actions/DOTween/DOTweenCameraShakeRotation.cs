...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenCameraShakeRotation : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DOShakeRotation(duration.Value, strength.Value, vibrato.Value, randomness.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Camera Shake Rotation");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Shakes a Transform's localRotation with the given values. ")]
    ...
    public class DOTweenTransformShakeRotation : FsmStateAction
    {
        ...
        public override void Reset()
        {
            base.Reset();
            gameObject = null;
            strength = new FsmVector3 { UseVariable = false, Value = new Vector3(90, 90, 90) };
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOShakeRotation(duration.Value, strength.Value, vibrato.Value, randomness.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Transform Shake Rotation");

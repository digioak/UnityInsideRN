...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTrailRendererTime : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TrailRenderer>().DOTime(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Trail Renderer Time");

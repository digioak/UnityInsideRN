...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a Material's color to the given value, in a way that allows other DOBlendableColor tweens to work together on the same target, instead than fight each other as multiple DOColor would do.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenMaterialBlendableColor : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOBlendableColor(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Material Blendable Color");

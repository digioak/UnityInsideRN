...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Changes the outline's color to the given one")]
    ...
    public class DOTweenOutlineColor : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Outline>().DOColor(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Outline Color");

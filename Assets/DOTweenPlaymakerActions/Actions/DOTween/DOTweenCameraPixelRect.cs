...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a Camera's pixelRect.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenCameraPixelRect : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DOPixelRect(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Camera PixelRect");

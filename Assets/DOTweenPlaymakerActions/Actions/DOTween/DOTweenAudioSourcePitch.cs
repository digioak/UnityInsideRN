...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens an AudioSource's pitch to the given value.")]
    ...
    public class DOTweenAudioSourcePitch : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<AudioSource>().DOPitch(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween AudioSource Pitch");

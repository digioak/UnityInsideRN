...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTextBlendableColor : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Text>().DOBlendableColor(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Text Blendable Color");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Changes the layoutElement's minWidth/Height to the given one ")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenLayoutElementMinSize : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<LayoutElement>().DOMinSize(to.Value, duration.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Layout Element Min Size");

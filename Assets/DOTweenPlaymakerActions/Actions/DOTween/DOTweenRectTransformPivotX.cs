...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens the target's pivot to the given value, tweening only the X axis.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenRectTransformPivotX : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOPivotX(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween RectTransform PivotX");

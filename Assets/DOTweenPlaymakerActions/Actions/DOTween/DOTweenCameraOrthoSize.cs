...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a Camera's orthographicSize.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenCameraOrthoSize : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DOOrthoSize(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Camera OrthoSize");

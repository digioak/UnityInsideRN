...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenCanvasGroupFade : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<CanvasGroup>().DOFade(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Canvas Group Fade");

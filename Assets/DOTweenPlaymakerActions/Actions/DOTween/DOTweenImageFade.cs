...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenImageFade : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Image>().DOFade(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Image Fade");

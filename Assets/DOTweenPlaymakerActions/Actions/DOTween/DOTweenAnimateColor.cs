...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Animates a color variable to a target value")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenAnimateColor : FsmStateAction
    {
        [RequiredField] public FsmOwnerDefault gameObject;

        [RequiredField] [UIHint(UIHint.FsmColor)] [Tooltip("The variable you want to animate")]
        public FsmColor variable;

        [RequiredField] [UIHint(UIHint.FsmColor)] [Tooltip("The end value you want to animate to")]
        public FsmColor to;
        ...
        public override void Reset()
        {
            base.Reset();
            gameObject = null;
            variable = new FsmColor {UseVariable = true};
            to = new FsmColor {UseVariable = false};
        ...
        {
            tween = DOTween.To(() => variable.Value, x => variable.Value = x, to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Animate Color");

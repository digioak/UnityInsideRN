...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens the target's pivot to the given value.")]
    ...
    public class DOTweenRectTransformPivot : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOPivot(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween RectTransform Pivot");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenSpriteRendererBlendableColor : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<SpriteRenderer>().DOBlendableColor(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Sprite Renderer Blendable Color");

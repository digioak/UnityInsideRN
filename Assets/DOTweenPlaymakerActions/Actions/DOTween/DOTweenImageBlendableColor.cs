...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenImageBlendableColor : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Image>().DOBlendableColor(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Image Blendable Color");

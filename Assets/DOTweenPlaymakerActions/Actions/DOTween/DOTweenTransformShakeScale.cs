...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Shakes a Transform's localScale with the given values. ")]
    ...
    public class DOTweenTransformShakeScale : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOShakeScale(duration.Value, strength.Value, vibrato.Value, randomness.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Transform Shake Scale");

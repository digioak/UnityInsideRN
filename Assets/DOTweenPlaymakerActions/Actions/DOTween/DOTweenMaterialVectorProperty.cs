...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Changes the target's named Vector property to the given one.")]
    ...
    public class DOTweenMaterialVectorProperty : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOVector(to.Value, property.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Material Vector Property");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens the target's horizontalNormalizedPosition property to the given value.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenScrollRectHorizontalNormalizedPos : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<ScrollRect>().DOHorizontalNormalizedPos(to.Value, duration.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween ScrollRect Horizontal NormalizedPos");

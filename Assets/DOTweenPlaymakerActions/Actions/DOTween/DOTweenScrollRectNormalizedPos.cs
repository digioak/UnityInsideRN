...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens the target's horizontalNormalizedPosition and verticalNormalizedPosition properties to the given value.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenScrollRectNormalizedPos : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<ScrollRect>().DONormalizedPos(to.Value, duration.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween ScrollRect NormalizedPos");

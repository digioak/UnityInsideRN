...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a Camera's rect.")]
    ...
    public class DOTweenCameraRect : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DORect(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Camera Rect");

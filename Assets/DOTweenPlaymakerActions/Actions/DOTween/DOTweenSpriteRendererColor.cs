...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenSpriteRendererColor : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<SpriteRenderer>().DOColor(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Sprite Renderer Color");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Fades the target's alpha to the given value.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenSpriteRendererFade : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<SpriteRenderer>().DOFade(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Sprite Renderer Fade");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Changes target's fillAmount to the given value (0 to 1).")]
    ...
    public class DOTweenImageFillAmount : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Image>().DOFillAmount(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Image Fill Amount");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens the target's sizeDelta to the given value. ")]
    ...
    public class DOTweenRectTransformSizeDelta : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOSizeDelta(to.Value, duration.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween RectTransform Size Delta");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens the target's anchorMin property to the given value. ")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenRectTransformAnchorMin : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOAnchorMin(to.Value, duration.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween RectTransform Anchor Min");

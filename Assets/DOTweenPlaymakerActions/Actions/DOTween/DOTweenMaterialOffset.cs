...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Changes the target's textureOffset to the given one.")]
    ...
    public class DOTweenMaterialOffset : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOOffset(to.Value, duration.Value);

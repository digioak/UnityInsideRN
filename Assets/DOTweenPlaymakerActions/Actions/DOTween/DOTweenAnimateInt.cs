...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Animates an int variable to a target value")]
    ...
    public class DOTweenAnimateInt : FsmStateAction
    {
        ...
        public override void Reset()
        {
            base.Reset();
            gameObject = null;
            variable = new FsmInt { UseVariable = true };
            to = new FsmInt { UseVariable = false };
        ...
        public override void OnEnter()
        {
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Animate Int");

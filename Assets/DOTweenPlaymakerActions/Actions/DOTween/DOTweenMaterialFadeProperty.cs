...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Fades the target's named alpha property to the given one.")]
    ...
    public class DOTweenMaterialFadeProperty : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOFade(to.Value, property.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Material Fade Property");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Fades the outline's alpha to the given value.")]
    ...
    public class DOTweenOutlineFade : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Outline>().DOFade(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Outline Fade");

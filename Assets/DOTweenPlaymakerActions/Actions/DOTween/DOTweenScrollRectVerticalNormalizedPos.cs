...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens the target's verticalNormalizedPosition property to the given value.")]
    ...
    public class DOTweenScrollRectVerticalNormalizedPos : FsmStateAction
    {
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<ScrollRect>().DOVerticalNormalizedPos(to.Value, duration.Value, snapping.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween ScrollRect Vertical NormalizedPos");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a Material's color property to the given value, in a way that allows other DOBlendableColor tweens to work together on the same target, instead than fight each other as multiple DOColor would do.")]
    ...
    public class DOTweenMaterialBlendableColorProperty : FsmStateAction
    {
        ...
        [Tooltip("The name of the material property to tween (like _Tint or _SpecColor)")]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOBlendableColor(to.Value, property.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Material Blendable Color Property");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a Camera's fieldOfView.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenCameraFieldOfView : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DOFieldOfView(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Camera FieldOfView");

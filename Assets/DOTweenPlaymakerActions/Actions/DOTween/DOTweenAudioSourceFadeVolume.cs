...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens an AudioSource's volume to the given value.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenAudioSourceFadeVolume : FsmStateAction
    {
        [RequiredField]
        ...
        [HasFloatSlider(0,1)]
        [Tooltip("The end value to reach (0 to 1)")]
        public FsmFloat to;
        ...
        {
            tween = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<AudioSource>().DOFade(to.Value, duration.Value);
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween AudioSource Fade Volume");
